...
const Login = () => {
  ...
  // 1. Initial Login (Credentials -> Dispatches OTP)
  ...
  // 2. Verify OTP -> Issues JWT
  const verifyOtpMutation = useApiMutation(
    ENDPOINTS.AUTH.LOGIN_VERIFY_OTP,
    "POST",
    {
      onSuccess: (data) => {
        handleAuthSuccess(data);
    ...
    <AuthLayout>
      {step === "credentials" ? (
        <>
          <div className="mb-8">
            ...
            <p className="mt-2 text-slate-400">
              Enter your credentials to receive an OTP on your Gmail.
            </p>
          </div>
        ...
        <>
          ...
          >
            <ArrowLeft size={16} /> Back to email & password
          </button>
